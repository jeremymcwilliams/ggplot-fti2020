...
* `library(usethis)`
* `use_course("https://github.com/jeremymcwilliams/ggplot-fti2020/archive/1.0.1.zip")`
...
* Enter the url: https://github.com/jeremymcwilliams/ggplot-fti2020
